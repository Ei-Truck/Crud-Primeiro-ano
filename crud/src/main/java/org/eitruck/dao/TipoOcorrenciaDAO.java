...
import org.eitruck.model.TipoOcorrencia;
...
public class TipoOcorrenciaDAO extends DAO {
    ...
    public boolean cadastrar(TipoOcorrencia tipoOcorrencia) {
        String comando = """
            INSERT INTO tipo_ocorrencia (id, tipo_evento, gravidade)
            VALUES (?, ?, ?)""";
    ...
    public List<TipoOcorrencia> buscarPorId(int idTipoOcorrencia) {
        ...
        try {
            ...
            while (rs.next()){
                TipoOcorrencia tipo = new TipoOcorrencia(rs.getInt("id"), rs.getString("tipo_evento"), rs.getString("gravidade"));
